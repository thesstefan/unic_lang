...
class _BSTNode(object):
    """ Private storage class for the BSTStrMap. """
...
class BSTMap(StrMap):
    ...
    def __setitem__(self, key, value):
        ...
        the symbol table then its value is modified.
        If key is not in the table, it is added."""
    ...
    def at_position(self, position: StrMapPosition):
        raise NotImplementedError

    def find_position(self, key: str) -> StrMapPosition:
        raise NotImplementedError
...
class _InorderBSTIterator(object):
    # Inorder Iterator class.  Traersal state is maintained between
    # calls using a stack.
